...
interface ICartItem {
	...
	addOnePizza: (id: number) => void,
	minusOnePizza: ( id: number ) => void
}



const CartItem: React.FC<ICartItem> = ({ id, name, type, size, totalPrice, totalCount, removePizzaFromCart, addOnePizza, minusOnePizza }) => {
